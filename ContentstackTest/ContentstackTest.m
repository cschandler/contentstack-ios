...
//- (void)testFetchAfterUid{
//
//    XCTestExpectation *expectation = [self expectationWithDescription:@"Fetch After Uid"];
//
//    ContentType* csForm = [csStack contentTypeWithName:@"product"];
//    NSString *objUid = _productUid;
//    Query* csQuery = [csForm query];
//    [csQuery afterUID:objUid];
//
//    Entry *entry = [csForm entryWithUID:objUid];
//
//    [entry fetch:^(ResponseType type, NSError * _Nonnull error) {
//        if (error) {
//            XCTFail(@"~ ERR: %@, Message = %@", error.userInfo, error.description);
...
//                } else {
//
//                    [[result getResult] enumerateObjectsUsingBlock:^(Entry *entryObj, NSUInteger idx, BOOL * _Nonnull stop) {
//                        [self checkLanguageStatus:entryObj];
//                        [self checkEnvironment:entryObj];
//
//                        if ([entryObj.updatedAt compare:entry.updatedAt] != NSOrderedDescending) {
//                            XCTFail(@"result objects should be created after given object.");
//                        }
//                    }];
//                    XCTAssert(YES,@"Pass");
//                }
...
//                        [self checkEnvironment:entryObj];
//
//                        if ([entryObj.updatedAt compare:entry.updatedAt] != NSOrderedAscending) {
//                            XCTFail(@"result objects should be created after given object.");
//                        }
//                    }];
//                    XCTAssert(YES,@"Pass");
